...
public class A2 {
   ...
   public static void PerformGame () {
      ...
      Console.ReadKey ();
      List<int> bitList = new () { 0, 0, 0, 0, 0, 0, 0 };
      List<int> twoPowers = new () { 64, 32, 16, 8, 4, 2, 1 };
      int n = 2;
      ...
      if (firstLSD == "o" || firstLSD == "O") bitList[6] = 1;
